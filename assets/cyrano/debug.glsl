...
void main(void)
{
    ...
    float fIsDigit4 = PrintValue(gl_FragCoord.xy, vPixelCoord4, vFontSize, fValue4, fDigits, fDecimalPlaces);
    ...
    // Print Date float PrintValue(in vec2 inFragCoord, const in vec2 vPixelCoords, const in vec2 vFontSize, const in float fValue, const in float fMaxDigits, const in float fDecimalPlaces)
    vColour = mix( vColour, vec3(1.0, 1.0, 0.0), PrintValue(gl_FragCoord.xy, vec2(280.0, 5.0), vFontSize, iDate.x, 4.0, 3.0));
    vColour = mix( vColour, vec3(1.0, 1.0, 0.0), PrintValue(gl_FragCoord.xy, vec2(280.0 + 72.0, 5.0), vFontSize, iDate.y, 2.0, 3.0));
    vColour = mix( vColour, vec3(1.0, 1.0, 0.0), PrintValue(gl_FragCoord.xy, vec2(280.0 + 144.0, 5.0), vFontSize, iDate.z, 2.0, 3.0));

    // Draw Time
    vColour = mix( vColour, vec3(1.0, 0.0, 1.0), PrintValue(gl_FragCoord.xy, vec2(184.0, 5.0), vFontSize, mod(iDate.w / (60.0 * 60.0) + 1.0, 12.0), 2.0, 0.0));
    vColour = mix( vColour, vec3(1.0, 0.0, 1.0), PrintValue(gl_FragCoord.xy, vec2(184.0 + 24.0, 5.0), vFontSize, iDate.y, 2.0, 0.0));
    vColour = mix( vColour, vec3(1.0, 0.0, 1.0), PrintValue(gl_FragCoord.xy, vec2(184.0 + 48.0, 5.0), vFontSize, iDate.z, 2.0, 0.0));
    // Fps
    vColour = mix( vColour, vec3(0.7, 0.0, 0.5), PrintValue(gl_FragCoord.xy, vec2(500.0, 5.0), vFontSize, iFps, 2.0, 0.0));
    // badtv
    //vColour = mix( vColour, vec3(0.7, 0.0, 0.5), PrintValue(gl_FragCoord.xy, vec2(0.0, 48.0), vFontSize, iBadTv, 2.0, 0.0));
    ...
    if(iMouse.x > 0.0)
    {
        ...
        fDigits = 1.0;
        fDecimalPlaces = 3.0;
        float fIsDigit2 = PrintValue(gl_FragCoord.xy, vPixelCoord2, vFontSize, fValue2, fDigits, fDecimalPlaces);
        ...
        fDigits = 1.0;
        float fIsDigit3 = PrintValue(gl_FragCoord.xy, vPixelCoord3, vFontSize, fValue3, fDigits, fDecimalPlaces);
